(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function a(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(n){if(n.ep)return;n.ep=!0;const r=a(n);fetch(n.href,r)}})();const V={mosque:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
  ...
  `,document.getElementById("theme-toggle").addEventListener("click",()=>{const n=document.documentElement,s=n.getAttribute("data-theme")==="light"?"dark":"light";n.setAttribute("data-theme",s),localStorage.setItem("theme",s),document.getElementById("theme-icon").innerHTML=s==="light"?'<path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path>':'<circle cx="12" cy="12" r="5"></circle><line x1="12" y1="1" x2="12" y2="3"></line><line x1="12" y1="21" x2="12" y2="23"></line><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"></line><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"></line><line x1="1" y1="12" x2="3" y2="12"></line><line x1="21" y1="12" x2="23" y2="12"></line><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"></line><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"></line>'})}const Qe=[{id:"prayer",label:"Namaz",icon:V.mosque},{id:"community",label:"Topluluk",icon:V.community},{id:"ilim",label:"İlim",icon:V.book},{id:"bagis",label:"Bağış",icon:V.heart},{id:"ziyaret",label:"Ziyaret",icon:V.compass}];function et(e,t){const a=document.getElementById("bottom-nav");a.innerHTML=Qe.map(i=>`
    <button class="nav-item ${e===i.id?"active":""}" data-page="${i.id}" id="nav-${i.id}">
      ${i.icon}
      <span>${i.label}</span>
    </button>
  `).join(""),a.querySelectorAll(".nav-item").forEach(i=>{i.addEventListener("click",()=>{const n=i.dataset.page;t(n)})})}const me=Math.PI/180,oe=180/Math.PI,he={Jafari:{name:"Shia Ithna-Ashari",fajrAngle:16,ishaAngle:14,maghribAngle:4,midnight:"Jafari"},ISNA:{name:"Islamic Society of North America",fajrAngle:15,ishaAngle:15,maghribAngle:0,midnight:"Standard"},MWL:{name:"Muslim World League",fajrAngle:18,ishaAngle:17,maghribAngle:0,midnight:"Standard"}};function tt(e,t,a){t<=2&&(e-=1,t+=12);const i=Math.floor(e/100),n=2-i+Math.floor(i/4);return Math.floor(365.25*(e+4716))+Math.floor(30.6001*(t+1))+a+n-1524.5}function re(e){const t=e-2451545,a=ce(357.529+.98560028*t),i=ce(280.459+.98564736*t),n=ce(i+1.915*D(a)+.02*D(2*a)),r=23.439-36e-8*t,s=ot(se(r)*D(n),se(n))/15,d=i/15-le(s);return{declination:it(D(r)*D(n)),equation:d}}function He(e,t){return le(12-t)}function R(e,t,a,i){const n=re(Q+t).declination,r=He(t,re(Q+t).equation),s=1/15*rt((-D(e)-D(n)*D(a))/(se(n)*se(a)));return r+(i==="ccw"?-s:s)}function at(e,t,a){const i=re(Q+t).declination,n=-st(1/(e+nt(Math.abs(a-i))));return R(n,t,a,"cw")}function D(e){return Math.sin(e*me)}function se(e){return Math.cos(e*me)}function nt(e){return Math.tan(e*me)}function it(e){return Math.asin(e)*oe}function rt(e){return Math.acos(e)*oe}function st(e){return Math.atan(e)*oe}function ot(e,t){return Math.atan2(e,t)*oe}function ce(e){return Re(e,360)}function le(e){return Re(e,24)}function Re(e,t){return e=e-t*Math.floor(e/t),e<0?e+t:e}let Q;function lt(e,t,a,i,n="Jafari"){const r=he[n]||he.Jafari,s=e.getFullYear(),d=e.getMonth()+1,l=e.getDate();Q=tt(s,d,l)-a/360;let o={imsak:5,fajr:5,sunrise:6,dhuhr:12,asr:13,sunset:18,maghrib:18,isha:18};for(let m=0;m<3;m++)o=dt(o,t,r);const v=i-a/15;for(const m in o)o[m]+=v;if(o.imsak=o.fajr-10/60,r.midnight==="Jafari"){const m=be(o.sunset,o.fajr);o.midnight=o.sunset+m/2}else{const m=be(o.sunset,o.sunrise);o.midnight=o.sunset+m/2}return o}function dt(e,t,a){const i=n=>re(Q+n);return{imsak:R(a.fajrAngle+.5,e.imsak,t,"ccw"),fajr:R(a.fajrAngle,e.fajr,t,"ccw"),sunrise:R(fe(),e.sunrise,t,"ccw"),dhuhr:He(e.dhuhr,i(e.dhuhr).equation),asr:at(1,e.asr,t),sunset:R(fe(),e.sunset,t,"cw"),maghrib:R(a.maghribAngle,e.maghrib,t,"cw"),isha:R(a.ishaAngle,e.isha,t,"cw")}}function fe(){return .833+.0347*Math.sqrt(0)}function be(e,t){return le(t-e)}function j(e){if(isNaN(e))return"--:--";e=le(e);const t=Math.floor(e),a=Math.floor((e-t)*60);return`${String(t).padStart(2,"0")}:${String(a).padStart(2,"0")}`}function xe(e,t,a,i){const n=lt(e,t,a,i,"Jafari");return{Fajr:j(n.fajr),Sunrise:j(n.sunrise),Dhuhr:j(n.dhuhr),Asr:j(n.asr),Sunset:j(n.sunset),Maghrib:j(n.maghrib),Isha:j(n.isha),Imsak:j(n.imsak),Midnight:j(n.midnight)}}function ct(e){const t=e.getFullYear(),a=e.getMonth()+1,i=e.getDate();let n=t,r=a;r<=2&&(n--,r+=12);const s=Math.floor(n/100),d=2-s+Math.floor(s/4),l=Math.floor(365.25*(n+4716))+Math.floor(30.6001*(r+1))+i+d-1524.5,o=Math.floor(l)-1948440+10632,v=Math.floor((o-1)/10631),m=o-10631*v+354,y=Math.floor((10985-m)/5316)*Math.floor(50*m/17719)+Math.floor(m/5670)*Math.floor(43*m/15238),c=m-Math.floor((30-y)/15)*Math.floor(17719*y/50)-Math.floor(y/16)*Math.floor(15238*y/43)+29,g=Math.floor(24*c/709),f=c-Math.floor(709*g/24),u=30*v+y-30,b=["Muharrem","Safer","Rebiülevvel","Rebiülahir","Cemaziyelevvel","Cemaziyelahir","Recep","Şaban","Ramazan","Şevval","Zilkade","Zilhicce"],p=["مُحَرَّم","صَفَر","رَبيع الأوَّل","رَبيع الثاني","جُمادى الأولى","جُمادى الآخرة","رَجَب","شَعبان","رَمَضان","شَوَّال","ذو القِعدة","ذو الحِجَّة"];return{day:Math.max(1,Math.min(30,f)),month:g,year:u,monthName:b[g-1]||"",monthNameAr:p[g-1]||""}}const Ke={"2026-04-05":{Fajr:"04:53",Sunrise:"06:20",Dhuhr:"12:56",Asr:"16:32",Maghrib:"19:23",Isha:"20:44",hijri:"17 Şevval 1447"},"2026-04-06":{Fajr:"04:51",Sunrise:"06:18",Dhuhr:"12:56",Asr:"16:33",Maghrib:"19:24",Isha:"20:45",hijri:"18 Şevval 1447"},"2026-04-07":{Fajr:"04:50",Sunrise:"06:17",Dhuhr:"12:56",Asr:"16:33",Maghrib:"19:25",Isha:"20:46",hijri:"19 Şevval 1447"},"2026-04-08":{Fajr:"04:48",Sunrise:"06:15",Dhuhr:"12:56",Asr:"16:33",Maghrib:"19:26",Isha:"20:48",hijri:"20 Şevval 1447"},"2026-04-09":{Fajr:"04:46",Sunrise:"06:14",Dhuhr:"12:55",Asr:"16:34",Maghrib:"19:27",Isha:"20:49",hijri:"21 Şevval 1447"},"2026-04-10":{Fajr:"04:44",Sunrise:"06:12",Dhuhr:"12:55",Asr:"16:34",Maghrib:"19:28",Isha:"20:50",hijri:"22 Şevval 1447"},"2026-04-11":{Fajr:"04:42",Sunrise:"06:11",Dhuhr:"12:55",Asr:"16:34",Maghrib:"19:29",Isha:"20:52",hijri:"23 Şevval 1447"},"2026-04-12":{Fajr:"04:40",Sunrise:"06:09",Dhuhr:"12:55",Asr:"16:35",Maghrib:"19:30",Isha:"20:53",hijri:"24 Şevval 1447"},"2026-04-13":{Fajr:"04:38",Sunrise:"06:07",Dhuhr:"12:54",Asr:"16:35",Maghrib:"19:31",Isha:"20:54",hijri:"25 Şevval 1447"},"2026-04-14":{Fajr:"04:37",Sunrise:"06:06",Dhuhr:"12:54",Asr:"16:35",Maghrib:"19:32",Isha:"20:55",hijri:"26 Şevval 1447"},"2026-04-15":{Fajr:"04:35",Sunrise:"06:04",Dhuhr:"12:54",Asr:"16:36",Maghrib:"19:33",Isha:"20:57",hijri:"27 Şevval 1447"},"2026-04-16":{Fajr:"04:33",Sunrise:"06:03",Dhuhr:"12:54",Asr:"16:36",Maghrib:"19:34",Isha:"20:58",hijri:"28 Şevval 1447"},"2026-04-17":{Fajr:"04:31",Sunrise:"06:01",Dhuhr:"12:53",Asr:"16:36",Maghrib:"19:35",Isha:"20:59",hijri:"29 Şevval 1447"},"2026-04-18":{Fajr:"04:29",Sunrise:"06:00",Dhuhr:"12:53",Asr:"16:36",Maghrib:"19:36",Isha:"21:01",hijri:"1 Zilkade 1447"},"2026-04-19":{Fajr:"04:27",Sunrise:"05:59",Dhuhr:"12:53",Asr:"16:37",Maghrib:"19:37",Isha:"21:02",hijri:"2 Zilkade 1447"},"2026-04-20":{Fajr:"04:26",Sunrise:"05:57",Dhuhr:"12:53",Asr:"16:37",Maghrib:"19:38",Isha:"21:03",hijri:"3 Zilkade 1447"},"2026-04-21":{Fajr:"04:24",Sunrise:"05:56",Dhuhr:"12:52",Asr:"16:37",Maghrib:"19:39",Isha:"21:05",hijri:"4 Zilkade 1447"},"2026-04-22":{Fajr:"04:22",Sunrise:"05:54",Dhuhr:"12:52",Asr:"16:38",Maghrib:"19:40",Isha:"21:06",hijri:"5 Zilkade 1447"},"2026-04-23":{Fajr:"04:20",Sunrise:"05:53",Dhuhr:"12:52",Asr:"16:38",Maghrib:"19:41",Isha:"21:08",hijri:"6 Zilkade 1447"},"2026-04-24":{Fajr:"04:18",Sunrise:"05:51",Dhuhr:"12:52",Asr:"16:38",Maghrib:"19:42",Isha:"21:09",hijri:"7 Zilkade 1447"},"2026-04-25":{Fajr:"04:17",Sunrise:"05:50",Dhuhr:"12:52",Asr:"16:38",Maghrib:"19:43",Isha:"21:10",hijri:"8 Zilkade 1447"},"2026-04-26":{Fajr:"04:15",Sunrise:"05:49",Dhuhr:"12:51",Asr:"16:39",Maghrib:"19:44",Isha:"21:12",hijri:"9 Zilkade 1447"},"2026-04-27":{Fajr:"04:13",Sunrise:"05:47",Dhuhr:"12:51",Asr:"16:39",Maghrib:"19:45",Isha:"21:13",hijri:"10 Zilkade 1447"},"2026-04-28":{Fajr:"04:11",Sunrise:"05:46",Dhuhr:"12:51",Asr:"16:39",Maghrib:"19:46",Isha:"21:15",hijri:"11 Zilkade 1447"},"2026-04-29":{Fajr:"04:10",Sunrise:"05:45",Dhuhr:"12:51",Asr:"16:39",Maghrib:"19:47",Isha:"21:16",hijri:"12 Zilkade 1447"},"2026-04-30":{Fajr:"04:08",Sunrise:"05:43",Dhuhr:"12:51",Asr:"16:40",Maghrib:"19:48",Isha:"21:17",hijri:"13 Zilkade 1447"},"2026-05-01":{Fajr:"04:06",Sunrise:"05:42",Dhuhr:"12:51",Asr:"16:40",Maghrib:"19:49",Isha:"21:19",hijri:"14 Zilkade 1447"},"2026-05-02":{Fajr:"04:04",Sunrise:"05:41",Dhuhr:"12:51",Asr:"16:40",Maghrib:"19:50",Isha:"21:20",hijri:"15 Zilkade 1447"},"2026-05-03":{Fajr:"04:03",Sunrise:"05:40",Dhuhr:"12:51",Asr:"16:40",Maghrib:"19:51",Isha:"21:22",hijri:"16 Zilkade 1447"},"2026-05-04":{Fajr:"04:01",Sunrise:"05:39",Dhuhr:"12:50",Asr:"16:41",Maghrib:"19:52",Isha:"21:23",hijri:"17 Zilkade 1447"},"2026-05-05":{Fajr:"03:59",Sunrise:"05:37",Dhuhr:"12:50",Asr:"16:41",Maghrib:"19:53",Isha:"21:25",hijri:"18 Zilkade 1447"},"2026-05-06":{Fajr:"03:58",Sunrise:"05:36",Dhuhr:"12:50",Asr:"16:41",Maghrib:"19:54",Isha:"21:26",hijri:"19 Zilkade 1447"}},ut=["Muharrem","Safer","Rebiülevvel","Rebiülahir","Cemaziyelevvel","Cemaziyelahir","Recep","Şaban","Ramazan","Şevval","Zilkade","Zilhicce"],mt=["مُحَرَّم","صَفَر","رَبيع الأوَّل","رَبيع الثاني","جُمادى الأولى","جُمادى الآخرة","رَجَب","شَعبان","رَمَضان","شَوَّال","ذو القِعدة","ذو الحِجَّة"];function pt(e){const t=`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,a=Ke[t];if(!a)return null;const i=a.hijri.split(" "),n=parseInt(i[0]),r=i[1],s=parseInt(i[2]),d=ut.indexOf(r);return{timings:{Fajr:a.Fajr,Sunrise:a.Sunrise,Dhuhr:a.Dhuhr,Asr:a.Asr,Maghrib:a.Maghrib,Isha:a.Isha},hijri:{day:n,month:d+1,year:s,monthName:r,monthNameAr:mt[d]||""},isStatic:!0}}const yt="modulepreload",gt=function(e){return"/"+e},ke={},vt=function(t,a,i){let n=Promise.resolve();if(a&&a.length>0){let s=function(o){return Promise.all(o.map(v=>Promise.resolve(v).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const d=document.querySelector("meta[property=csp-nonce]"),l=(d==null?void 0:d.nonce)||(d==null?void 0:d.getAttribute("nonce"));n=s(a.map(o=>{if(o=gt(o),o in ke)return;ke[o]=!0;const v=o.endsWith(".css"),m=v?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${m}`))return;const y=document.createElement("link");if(y.rel=v?"stylesheet":yt,v||(y.as="script"),y.crossOrigin="",y.href=o,l&&y.setAttribute("nonce",l),document.head.appendChild(y),v)return new Promise((c,g)=>{y.addEventListener("load",c),y.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${o}`)))})}))}function r(s){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=s,window.dispatchEvent(d),!d.defaultPrevented)throw s}return n.then(s=>{for(const d of s||[])d.status==="rejected"&&r(d.reason);return t().catch(r)})};/*! Capacitor: https://capacitorjs.com/ - MIT License */var Y;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Y||(Y={}));class ue extends Error{constructor(t,a,i){super(t),this.message=t,this.code=a,this.data=i}}const ht=e=>{var t,a;return e!=null&&e.androidBridge?"android":!((a=(t=e==null?void 0:e.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},ft=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},i=a.Plugins=a.Plugins||{},n=()=>t!==null?t.name:ht(e),r=()=>n()!=="web",s=m=>{const y=o.get(m);return!!(y!=null&&y.platforms.has(n())||d(m))},d=m=>{var y;return(y=a.PluginHeaders)===null||y===void 0?void 0:y.find(c=>c.name===m)},l=m=>e.console.error(m),o=new Map,v=(m,y={})=>{const c=o.get(m);if(c)return console.warn(`Capacitor plugin "${m}" already registered. Cannot register plugins twice.`),c.proxy;const g=n(),f=d(m);let u;const b=async()=>(!u&&g in y?u=typeof y[g]=="function"?u=await y[g]():u=y[g]:t!==null&&!u&&"web"in y&&(u=typeof y.web=="function"?u=await y.web():u=y.web),u),p=(z,I)=>{var L,q;if(f){const P=f==null?void 0:f.methods.find(S=>I===S.name);if(P)return P.rtype==="promise"?S=>a.nativePromise(m,I.toString(),S):(S,ee)=>a.nativeCallback(m,I.toString(),S,ee);if(z)return(L=z[I])===null||L===void 0?void 0:L.bind(z)}else{if(z)return(q=z[I])===null||q===void 0?void 0:q.bind(z);throw new ue(`"${m}" plugin is not implemented on ${g}`,Y.Unimplemented)}},h=z=>{let I;const L=(...q)=>{const P=b().then(S=>{const ee=p(S,z);if(ee){const te=ee(...q);return I=te==null?void 0:te.remove,te}else throw new ue(`"${m}.${z}()" is not implemented on ${g}`,Y.Unimplemented)});return z==="addListener"&&(P.remove=async()=>I()),P};return L.toString=()=>`${z.toString()}() { [capacitor code] }`,Object.defineProperty(L,"name",{value:z,writable:!1,configurable:!1}),L},x=h("addListener"),E=h("removeListener"),_=(z,I)=>{const L=x({eventName:z},I),q=async()=>{const S=await L;E({eventName:z,callbackId:S},I)},P=new Promise(S=>L.then(()=>S({remove:q})));return P.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await q()},P},U=new Proxy({},{get(z,I){switch(I){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return f?_:x;case"removeListener":return E;default:return h(I)}}});return i[m]=U,o.set(m,{name:m,proxy:U,platforms:new Set([...Object.keys(y),...f?[g]:[]])}),U};return a.convertFileSrc||(a.convertFileSrc=m=>m),a.getPlatform=n,a.handleError=l,a.isNativePlatform=r,a.isPluginAvailable=s,a.registerPlugin=v,a.Exception=ue,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},bt=e=>e.Capacitor=ft(e),M=bt(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),de=M.registerPlugin;class pe{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let i=!1;this.listeners[t]||(this.listeners[t]=[],i=!0),this.listeners[t].push(a);const r=this.windowListeners[t];r&&!r.registered&&this.addWindowListener(r),i&&this.sendRetainedArgumentsForEvent(t);const s=async()=>this.removeListener(t,a);return Promise.resolve({remove:s})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,i){const n=this.listeners[t];if(!n){if(i){let r=this.retainedEventArguments[t];r||(r=[]),r.push(a),this.retainedEventArguments[t]=r}return}n.forEach(r=>r(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:i=>{this.notifyListeners(a,i)}}}unimplemented(t="not implemented"){return new M.Exception(t,Y.Unimplemented)}unavailable(t="not available"){return new M.Exception(t,Y.Unavailable)}async removeListener(t,a){const i=this.listeners[t];if(!i)return;const n=i.indexOf(a);this.listeners[t].splice(n,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(i=>{this.notifyListeners(t,i)}))}}const we=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Ee=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class xt extends pe{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(i=>{if(i.length<=0)return;let[n,r]=i.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");n=Ee(n).trim(),r=Ee(r).trim(),a[n]=r}),a}async setCookie(t){try{const a=we(t.key),i=we(t.value),n=t.expires?`; expires=${t.expires.replace("expires=","")}`:"",r=(t.path||"/").replace("path=",""),s=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${i||""}${n}; path=${r}; ${s};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}de("CapacitorCookies",{web:()=>new xt});const kt=async e=>new Promise((t,a)=>{const i=new FileReader;i.onload=()=>{const n=i.result;t(n.indexOf(",")>=0?n.split(",")[1]:n)},i.onerror=n=>a(n),i.readAsDataURL(e)}),wt=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(n=>n.toLocaleLowerCase()).reduce((n,r,s)=>(n[r]=e[t[s]],n),{})},Et=(e,t=!0)=>e?Object.entries(e).reduce((i,n)=>{const[r,s]=n;let d,l;return Array.isArray(s)?(l="",s.forEach(o=>{d=t?encodeURIComponent(o):o,l+=`${r}=${d}&`}),l.slice(0,-1)):(d=t?encodeURIComponent(s):s,l=`${r}=${d}`),`${i}&${l}`},"").substr(1):null,_t=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),n=wt(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(n.includes("application/x-www-form-urlencoded")){const r=new URLSearchParams;for(const[s,d]of Object.entries(e.data||{}))r.set(s,d);a.body=r.toString()}else if(n.includes("multipart/form-data")||e.data instanceof FormData){const r=new FormData;if(e.data instanceof FormData)e.data.forEach((d,l)=>{r.append(l,d)});else for(const d of Object.keys(e.data))r.append(d,e.data[d]);a.body=r;const s=new Headers(a.headers);s.delete("content-type"),a.headers=s}else(n.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class zt extends pe{async request(t){const a=_t(t,t.webFetchExtra),i=Et(t.params,t.shouldEncodeUrlParams),n=i?`${t.url}?${i}`:t.url,r=await fetch(n,a),s=r.headers.get("content-type")||"";let{responseType:d="text"}=r.ok?t:{};s.includes("application/json")&&(d="json");let l,o;switch(d){case"arraybuffer":case"blob":o=await r.blob(),l=await kt(o);break;case"json":l=await r.json();break;case"document":case"text":default:l=await r.text()}const v={};return r.headers.forEach((m,y)=>{v[y]=m}),{data:l,headers:v,status:r.status,url:r.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}de("CapacitorHttp",{web:()=>new zt});var _e;(function(e){e.Dark="DARK",e.Light="LIGHT",e.Default="DEFAULT"})(_e||(_e={}));var ze;(function(e){e.StatusBar="StatusBar",e.NavigationBar="NavigationBar"})(ze||(ze={}));class Bt extends pe{async setStyle(){this.unavailable("not available for web")}async setAnimation(){this.unavailable("not available for web")}async show(){this.unavailable("not available for web")}async hide(){this.unavailable("not available for web")}}de("SystemBars",{web:()=>new Bt});var Be;(function(e){e[e.Sunday=1]="Sunday",e[e.Monday=2]="Monday",e[e.Tuesday=3]="Tuesday",e[e.Wednesday=4]="Wednesday",e[e.Thursday=5]="Thursday",e[e.Friday=6]="Friday",e[e.Saturday=7]="Saturday"})(Be||(Be={}));const O=de("LocalNotifications",{web:()=>vt(()=>import("./web-Bye830W1.js"),[]).then(e=>new e.LocalNotificationsWeb)}),Ie=39.9334,Ae=32.8597,$e=3,Z=[{key:"Fajr",name:"İmsak",icon:"🌙"},{key:"Sunrise",name:"Güneş",icon:"🌅"},{key:"Dhuhr",name:"Öğle",icon:"☀️"},{key:"Asr",name:"İkindi",icon:"🌤️"},{key:"Maghrib",name:"Akşam",icon:"🌆"},{key:"Isha",name:"Yatsı",icon:"🌃"}],W=[{id:"haci-ruslan",name:"Hacı Ruslan",desc:"Hacı Ruslan sesi ile ezan",file:"/assets/audio/Haci Ruslan.mp3"},{id:"rahim-muazzinzade",name:"Rahim Müəzzinzade",desc:"Rahim Müəzzinzade sesi ile ezan",file:"/assets/audio/Rahim Muazzinzade.mp3"}];let A=localStorage.getItem("selectedEzan")||"haci-ruslan",H=localStorage.getItem("abdestReminder")!=="false",T=localStorage.getItem("ezanAutoPlay")!=="false",G=null,B=null,C=!1,Se={},Le={};function It(){const e=new Date,t=pt(e);if(t){const n=xe(e,Ie,Ae,$e);return t.timings.Sunset=n.Sunset,t.timings.Midnight=n.Midnight,{timings:t.timings,hijri:t.hijri,date:e,isStatic:!0}}const a=xe(e,Ie,Ae,$e),i=ct(e);return{timings:a,hijri:i,date:e,isStatic:!1}}function Oe(e){const t=new Date,a=t.getHours()*60+t.getMinutes();for(const i of Z){const n=e[i.key];if(!n||n==="--:--")continue;const[r,s]=n.split(":").map(Number),d=r*60+s;if(d>a)return{...i,time:n,prayerMinutes:d}}return{...Z[0],time:e.Fajr,prayerMinutes:1440}}function Ne(e){const t=new Date,[a,i]=e.split(":").map(Number);let n=a*60+i-(t.getHours()*60+t.getMinutes());n<0&&(n+=1440);const r=Math.floor(n/60),s=n%60,d=59-t.getSeconds();return`${String(r).padStart(2,"0")}:${String(s).padStart(2,"0")}:${String(d).padStart(2,"0")}`}function ye(e){const t=new Date,[a,i]=e.split(":").map(Number);let n=a*60+i-(t.getHours()*60+t.getMinutes());return n<0&&(n+=1440),n}function Fe(e){const t=W.find(a=>a.id===e);if(t){if(B&&C){B.pause(),C=!1,ne(),ie(!1);return}B&&(B.pause(),B=null),B=new Audio(t.file),B.volume=1,C=!0,B.play().catch(a=>{console.warn("Ezan playing failed:",a),C=!1}),B.addEventListener("ended",()=>{C=!1,ne(),ie(!1)}),B.addEventListener("timeupdate",()=>{At(B)}),ne(),ie(!0)}}function Ge(){B&&(B.pause(),B.currentTime=0,B=null,C=!1,ne(),ie(!1))}function ne(){document.querySelectorAll(".ezan-play-btn").forEach(e=>{e.dataset.ezanId===A&&C?(e.innerHTML='<svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><rect x="6" y="4" width="4" height="16" rx="1"/><rect x="14" y="4" width="4" height="16" rx="1"/></svg>',e.classList.add("playing")):(e.innerHTML='<svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><polygon points="5,3 19,12 5,21"/></svg>',e.classList.remove("playing"))})}function ie(e){const t=document.getElementById("ezan-waveform");t&&(e?t.classList.add("active"):t.classList.remove("active"))}function At(e){const t=document.getElementById("ezan-progress-fill"),a=document.getElementById("ezan-time");if(t&&e.duration){const i=e.currentTime/e.duration*100;t.style.width=`${i}%`}if(a&&e.duration){const i=Te(e.currentTime),n=Te(e.duration);a.textContent=`${i} / ${n}`}}function Te(e){const t=Math.floor(e/60),a=Math.floor(e%60);return`${t}:${String(a).padStart(2,"0")}`}function $t(e){const t=new Date,a=`${String(t.getHours()).padStart(2,"0")}:${String(t.getMinutes()).padStart(2,"0")}`;for(const i of Z){const n=e[i.key];if(!n||n==="--:--")continue;H&&ye(n)===15&&!Le[i.key]&&(Le[i.key]=!0,Notification.permission==="granted"&&new Notification("🚿 Abdest Vaktidir",{body:`${i.icon} ${i.name} namazına 15 dakika kaldı — Abdest almayı unutmayın!`,icon:"/assets/favicon.svg",tag:`abdest-${i.key}`}),St(i));const r=["Fajr","Dhuhr","Maghrib"].includes(i.key);if(T&&r&&n===a&&!Se[i.key]){Se[i.key]=!0;try{"Notification"in window&&Notification.permission==="granted"&&new Notification(`${i.icon} ${i.name} Vakti`,{body:`${i.name} vakti geldi — Ezan okunuyor`,icon:"/assets/favicon.svg",tag:`ezan-${i.key}`})}catch(s){console.warn("Background notification failed",s)}Fe(A)}}}function St(e){var i;const t=document.getElementById("abdest-toast");t&&t.remove();const a=document.createElement("div");a.id="abdest-toast",a.className="abdest-toast abdest-toast--show",a.innerHTML=`
    ...
    <div class="page">
      ...
      <div class="prayer-hero">
        ...
        <div class="prayer-hero__date">
          ...
          <span class="text-muted" style="font-size:12px">${d}</span>
        </div>
      </div>
      ...
      <div class="prayer-list">
        ${Z.map(c=>`
            <div class="prayer-item ${r.key===c.key?"prayer-item--active":""}">
              <div class="prayer-item__left">
                <div class="prayer-item__icon">${c.icon}</div>
                <span class="prayer-item__name">${c.name}</span>
              </div>
              <span class="prayer-item__time">${a[c.key]||"--:--"}</span>
            </div>
          `).join("")}
      </div>
      ...
      <div class="ezan-selector">
        ...
        <div class="ezan-player-card" id="ezan-player-card">
          <div class="ezan-player__header">
            ...
            <div>
              ...
              <div class="ezan-player__muezzin" id="ezan-current-name">${((y=W.find(c=>c.id===A))==null?void 0:y.name)||"Hacı Ruslan"}</div>
            </div>
          </div>
        ...
        <div class="ezan-options">
          ${W.map(c=>`
            <div class="ezan-option ${A===c.id?"ezan-option--active":""}" data-ezan="${c.id}" id="ezan-${c.id}">
              <div class="ezan-option__radio"></div>
              <div class="ezan-option__info">
                <div class="ezan-option__label">${c.name}</div>
                <div class="ezan-option__desc">${c.desc}</div>
              </div>
              <button class="ezan-play-btn" data-ezan-id="${c.id}" id="ezan-play-${c.id}" title="Dinle">
  ...
  `,e.querySelectorAll(".ezan-option").forEach(c=>{c.addEventListener("click",g=>{if(g.target.closest(".ezan-play-btn"))return;A=c.dataset.ezan,localStorage.setItem("selectedEzan",A),M.isNativePlatform()&&X(),e.querySelectorAll(".ezan-option").forEach(b=>b.classList.remove("ezan-option--active")),c.classList.add("ezan-option--active");const f=document.getElementById("ezan-current-name"),u=W.find(b=>b.id===A);f&&u&&(f.textContent=u.name)})}),e.querySelectorAll(".ezan-play-btn").forEach(c=>{c.addEventListener("click",g=>{g.stopPropagation();const f=c.dataset.ezanId;if(f!==A){A=f,localStorage.setItem("selectedEzan",A),M.isNativePlatform()&&X(),e.querySelectorAll(".ezan-option").forEach(x=>x.classList.remove("ezan-option--active"));const b=c.closest(".ezan-option");b&&b.classList.add("ezan-option--active");const p=document.getElementById("ezan-current-name"),h=W.find(x=>x.id===A);p&&h&&(p.textContent=h.name),Ge()}Fe(f);const u=document.getElementById("ezan-status");u&&(u.textContent=C?"🔊 Çalıyor":"🔇 Sessiz")})});const v=document.getElementById("toggle-ezan");v&&(v.checked=T,v.addEventListener("change",()=>{T=v.checked,localStorage.setItem("ezanAutoPlay",T?"true":"false"),M.isNativePlatform()&&X();const c=document.getElementById("ezan-status");c&&(T?(c.textContent=C?"🔊 Çalıyor":"🔔 Aktif",c.classList.remove("badge--muted")):(c.textContent="🔇 Sessiz",c.classList.add("badge--muted")))}));const m=document.getElementById("toggle-abdest");m&&m.addEventListener("change",()=>{H=m.checked,localStorage.setItem("abdestReminder",H?"true":"false"),M.isNativePlatform()&&X()}),Lt(a),M.isNativePlatform()&&X()}async function X(){if(M.isNativePlatform())try{if((await O.checkPermissions()).display!=="granted"&&(await O.requestPermissions()).display!=="granted")return;const t=await O.getPending();if(t.notifications.length>0&&await O.cancel({notifications:t.notifications}),!T&&!H)return;const a=[],i=new Date;let n=1;const r=A==="haci-ruslan"?"haci_ruslan.mp3":"rahim_muazzinzade.mp3";M.getPlatform()==="android"&&await O.createChannel({id:"ezan-channel",name:"Ezan Bildirimleri",description:"Vakit girdiğinde ezan okur",importance:5,visibility:1,sound:r,vibration:!0}),Object.entries(Ke).forEach(([s,d])=>{const[l,o,v]=s.split("-").map(Number);new Date(l,o-1,v).getTime()<i.getTime()-864e5||["Fajr","Dhuhr","Asr","Maghrib","Isha"].forEach(y=>{const c=d[y];if(!c||c==="--:--")return;const[g,f]=c.split(":").map(Number),u=new Date(l,o-1,v,g,f,0),b=["Fajr","Dhuhr","Maghrib"].includes(y);if(T&&b&&u.getTime()>i.getTime()){const p=Z.find(h=>h.key===y);a.push({title:`${p?p.icon+" "+p.name:y} Vakti`,body:"Otomatik ezan okunuyor",id:n++,schedule:{at:u,allowWhileIdle:!0},sound:r,channelId:"ezan-channel"})}if(H){const p=new Date(u.getTime());if(p.setMinutes(p.getMinutes()-15),p.getTime()>i.getTime()){const h=Z.find(x=>x.key===y);a.push({title:"🚿 Abdest Vaktidir",body:`${h?h.icon+" "+h.name:y} namazına 15 dakika kaldı`,id:n++,schedule:{at:p,allowWhileIdle:!0}})}}})}),a.length>0&&(await O.schedule({notifications:a.slice(0,400)}),console.log(`[Native] Scheduled ${Math.min(a.length,400)} background notifications.`))}catch(e){console.error("Failed to schedule native notifications:",e)}}function Mt(){G&&(clearInterval(G),G=null),Ge()}let ae=null;async function Ct(){var t,a,i,n,r;const e=document.getElementById("page-content");e.innerHTML=`
  ...
  `;try{const[s,d]=await Promise.all([w("/community/announcements/"),w("/community/help-requests/")]);if(s._error)throw new Error("Duyurular yüklenemedi");e.innerHTML=`
      <div class="page">
        <!-- Community banner -->
    ...
    `,e.querySelectorAll(".help-card").forEach(l=>{l.addEventListener("click",()=>{const o=parseInt(l.dataset.helpIdx),v=d[o],m=document.getElementById("help-detail-panel"),y=document.getElementById("help-detail-title"),c=document.getElementById("help-detail-list");if(ae===o){m.style.display="none",ae=null,e.querySelectorAll(".help-card").forEach(g=>g.classList.remove("help-card--active"));return}ae=o,e.querySelectorAll(".help-card").forEach(g=>g.classList.remove("help-card--active")),l.classList.add("help-card--active"),y.textContent=`${v.icon} ${v.title}`,v.items&&v.items.length>0?c.innerHTML=v.items.map(g=>`
  ...
  `;try{let[n,r]=await Promise.all([w("/ilim/hadith/today/"),w("/ilim/questions/")]);n._error&&(n={text:"İlim talep etmek her Müslüman'a farzdır.",source:"Hz. Muhammed (s.a.a)",reference:"Usul-u Kâfi, c.1, s.30"}),r._error&&(r=[]),e.innerHTML=`
      <div class="page">
        ...
        <div class="ask-section">
          ...
          <div class="qa-list" id="qa-list">
            ${r.length>0?r.map((s,d)=>`
              <div class="qa-item qa-item--collapsed ${d>=3?"qa-item--hidden":""}" data-qa-idx="${d}" id="qa-item-${d}">
                <div class="qa-item__question qa-toggle" data-qa-target="${d}">
                  <span class="qa-item__q-icon">S</span>
                  <span style="flex:1">${s.question}</span>
                  <span class="qa-item__chevron">›</span>
                </div>
                <div class="qa-item__answer-wrap" id="qa-answer-${d}" style="display:none">
        ...
        <div class="library-list">
          ${Ce.map((s,d)=>`
            <div class="library-item" data-book-idx="${d}" id="book-${d}">
            ...
            <div class="library-detail" id="book-detail-${d}" style="display:none">
    ...
    `,(t=document.getElementById("ask-form"))==null||t.addEventListener("submit",async s=>{s.preventDefault();const d=document.getElementById("question-input"),l=document.getElementById("anonymous-check").checked,o=document.getElementById("private-check").checked;if(!d.value.trim())return;const v=document.getElementById("ask-submit-btn");v.disabled=!0,v.textContent="Gönderiliyor...",(await w("/ilim/questions/",{method:"POST",body:{text:d.value,is_anonymous:l,is_private:o},requireAuth:!0}))._error?(k("Soru gönderilirken bir hata oluştu.","error"),v.disabled=!1,v.textContent="Soruyu Gönder"):(k("Sorunuz başarıyla iletildi!","success"),d.value="",v.disabled=!1,v.textContent="Soruyu Gönder")}),e.querySelectorAll(".qa-toggle").forEach(s=>{s.addEventListener("click",()=>{const d=s.dataset.qaTarget,l=document.getElementById(`qa-answer-${d}`),o=document.getElementById(`qa-item-${d}`),v=s.querySelector(".qa-item__chevron");l.style.display==="none"?(l.style.display="block",o.classList.remove("qa-item--collapsed"),o.classList.add("qa-item--expanded"),v&&(v.textContent="⌄")):(l.style.display="none",o.classList.add("qa-item--collapsed"),o.classList.remove("qa-item--expanded"),v&&(v.textContent="›"))})}),(a=document.getElementById("qa-show-more"))==null||a.addEventListener("click",()=>{e.querySelectorAll(".qa-item--hidden").forEach(s=>{s.classList.remove("qa-item--hidden"),s.style.animation="fadeIn 0.3s ease"}),document.getElementById("qa-show-more").remove()}),e.querySelectorAll(".library-item").forEach(s=>{s.addEventListener("click",()=>{const d=parseInt(s.dataset.bookIdx),l=document.getElementById(`book-detail-${d}`);if(J!==null&&J!==d){const o=document.getElementById(`book-detail-${J}`);o&&(o.style.display="none")}l.style.display==="none"?(l.style.display="block",J=d):(l.style.display="none",J=null)})}),(i=document.getElementById("hadith-share-btn"))==null||i.addEventListener("click",async()=>{const s={title:"Günün Hadisi — Ehli-Beyt Ankara",text:`${n.text}
— ${n.source}
(${n.reference})`};if(navigator.share)try{await navigator.share(s)}catch{}else await navigator.clipboard.writeText(s.text),k("Hadis panoya kopyalandı!","success")})}catch{e.innerHTML='<div class="page text-center"><p class="text-danger">Bağlantı hatası: İçerikler yüklenemedi.</p></div>'}}async function qt(){const e=document.getElementById("page-content");e.innerHTML=`
  ...
  `;try{const t=await w("/bagis/campaigns/");if(t._error)throw new Error("Kampanyalar yüklenemedi");e.innerHTML=`
    ...
    `;let a="Humus",i=50;const n=e.querySelectorAll(".donation-type-card");n.forEach(l=>{l.addEventListener("click",()=>{n.forEach(o=>o.classList.remove("donation-type-card--active")),l.classList.add("donation-type-card--active"),a=l.dataset.type})});const r=e.querySelectorAll(".amount-btn"),s=document.getElementById("custom-amount-container"),d=document.getElementById("custom-amount-input");r.forEach(l=>{l.addEventListener("click",()=>{r.forEach(o=>o.classList.remove("amount-btn--active")),l.classList.add("amount-btn--active"),l.dataset.amount==="custom"?(s.style.display="block",d.focus(),i=0):(s.style.display="none",i=parseInt(l.dataset.amount))})}),document.getElementById("donation-form").addEventListener("submit",async l=>{l.preventDefault();let o=i;if(document.getElementById("custom-amount-btn").classList.contains("amount-btn--active")&&(o=parseInt(d.value),!o||o<=0)){k("Lütfen geçerli bir miktar girin.","error");return}const v=document.getElementById("campaign-select").value,m=document.getElementById("donor-name").value,y={amount:o,donation_type:a,donor_name:m||"Anonim"};v&&(y.campaign=parseInt(v));const c=document.getElementById("donate-submit-btn");c.disabled=!0,c.textContent="İşleniyor...",(await w("/bagis/donate/",{method:"POST",body:y,requireAuth:!0}))._error?(k("Bağış işlemi sırasında bir hata oluştu.","error"),c.disabled=!1,c.textContent="💳 Bağış Yap"):(k("Bağışınız başarıyla alındı. Allah kabul etsin!","success",5e3),setTimeout(()=>{window.location.reload()},2e3))})}catch{e.innerHTML='<div class="page text-center"><p class="text-danger">Bağlantı hatası: Kampanyalar yüklenemedi.</p></div>'}}const je=[{icon:"🕋",title:"İmam Hüseyin (a.s) Ziyaretnamesi",desc:"Kerbela · Türkçe & Arapça",content:`<div class="ziyaret-content">
  ...
  `,document.getElementById("kuran-back-btn").addEventListener("click",()=>{window.location.hash="ilim"});let a=[],i=[],n=-1,r=!1;const s=document.getElementById("kuran-audio"),d=document.getElementById("btn-play-pause");try{a=(await(await fetch("https://api.alquran.cloud/v1/surah")).json()).data;const f=document.getElementById("surah-selector");f.innerHTML=a.map(u=>`<option value="${u.number}">${u.number}. ${u.englishName} (${u.name})</option>`).join(""),document.getElementById("kuran-initial-loader").style.display="none",document.getElementById("kuran-content").style.display="block",f.addEventListener("change",u=>{l(parseInt(u.target.value))}),s.addEventListener("ended",()=>{n<i.length-1?o(n+1):v()}),s.addEventListener("play",()=>{r=!0,m(),y(n)}),s.addEventListener("pause",()=>{r=!1,m(),y(n)}),d.addEventListener("click",()=>{n===-1?i.length>0&&o(0):r?s.pause():s.play()}),document.getElementById("btn-prev-ayah").addEventListener("click",()=>{n>0&&o(n-1)}),document.getElementById("btn-next-ayah").addEventListener("click",()=>{n<i.length-1&&o(n+1)}),l(1)}catch(c){console.error("Kuran loading error",c),e.innerHTML=`<div class="page text-center"><p class="text-danger">Kur'an verileri yüklenemedi. Lütfen internet bağlantınızı kontrol edin.</p></div>`}async function l(c){v(),n=-1,document.getElementById("kuran-player").classList.remove("visible");const g=document.getElementById("verses-list");g.innerHTML='<div class="kuran-loading"><div class="kuran-loading-spinner"></div><p>Ayetler yükleniyor...</p></div>';try{const u=await(await fetch(`https://api.alquran.cloud/v1/surah/${c}/editions/quran-uthmani,tr.diyanet,ar.alafasy`)).json(),b=u.data[0],p=u.data[1],h=u.data[2],x=a[c-1];document.getElementById("surah-ar-name").textContent=x.name,document.getElementById("surah-tr-name").textContent=x.englishNameTranslation,document.getElementById("surah-revelation").textContent=x.revelationType==="Meccan"?"Mekki":"Medeni",document.getElementById("surah-ayah-count").textContent=x.numberOfAyahs,document.getElementById("player-surah-name").textContent=x.englishName,i=b.ayahs.map((E,_)=>({numberInSurah:E.numberInSurah,textAr:E.text,textTr:p.ayahs[_].text,audio:h.ayahs[_].audio})),g.innerHTML=i.map((E,_)=>`
      ...
      `).join(""),document.querySelectorAll(".ayah-play-btn").forEach(E=>{E.addEventListener("click",_=>{const U=parseInt(_.currentTarget.dataset.idx);o(U)})})}catch{g.innerHTML='<p class="text-danger" style="text-align:center">Ayetler yüklenemedi.</p>'}}function o(c){if(!i[c])return;n=c;const g=i[c];s.src=g.audio,s.play(),document.getElementById("kuran-player").classList.add("visible"),document.getElementById("player-ayah-number").textContent=`Ayet ${g.numberInSurah}`;const f=document.getElementById(`ayah-card-${c}`);if(f){const b=f.getBoundingClientRect().top+window.scrollY+-80;window.scrollTo({top:b,behavior:"smooth"})}}function v(){s.pause()}function m(){r?d.innerHTML='<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><rect x="6" y="4" width="4" height="16"></rect><rect x="14" y="4" width="4" height="16"></rect></svg>':d.innerHTML='<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>'}function y(c){if(document.querySelectorAll(".ayah-card").forEach(g=>g.classList.remove("playing")),c!==-1){const g=document.getElementById(`ayah-card-${c}`);g&&r&&g.classList.add("playing")}}}function Rt(){const e=document.getElementById("kuran-audio");e&&(e.pause(),e.src="")}function Kt(){const e=document.getElementById("page-content");e.innerHTML=`
    <div class="page">
  ...
  `;try{const t=await w("/auth/profile/",{requireAuth:!0});if(t._error){window.location.hash="#auth";return}if(e.innerHTML=`
  ...
  `;const t=document.getElementById("admin-dashboard-grid"),a=document.getElementById("admin-content-area"),i=document.getElementById("btn-back-to-menu"),n=document.getElementById("admin-title"),r=c=>{if(c==="dashboard")t.style.display="grid",a.style.display="none",i.style.display="none",n.textContent="⚙️ Yönetim Paneli";else{t.style.display="none",a.style.display="block",i.style.display="block";const g={questions:"🙋 Gelen Sorular",announce:"📢 Duyuru Yayınla",tours:"👥 Tur Kayıtları",tourmanage:"🕋 Turları Yönet",campaigns:"💎 Kampayaları Yönet"};n.textContent=g[c]||"Yönetim",["questions","announce","tours","tourmanage","campaigns"].forEach(f=>{document.getElementById(`tab-content-${f}`).style.display=f===c?"block":"none"}),window.scrollTo({top:0,behavior:"smooth"})}};e.querySelectorAll(".admin-module-card").forEach(c=>{c.addEventListener("click",()=>r(c.dataset.module))}),i.addEventListener("click",()=>r("dashboard")),await Promise.all([s(),d(),l(),o(),v()]);async function s(){const c=await w("/ilim/questions/unanswered/",{requireAuth:!0}),g=document.getElementById("tab-content-questions"),f=document.getElementById("stat-questions-label");if(f&&(f.textContent=c._error?"Hata":`${c.length} bekleyen`),c._error||c.length===0){g.innerHTML='<div class="card card--dark" style="padding:24px; text-align:center; color:var(--text-muted); font-size:14px;">🎉 Tüm sorular cevaplanmış! Bekleyen soru yok.</div>';return}g.innerHTML=c.map(u=>`
    ...
    `).join(""),g.querySelectorAll(".answer-btn").forEach(u=>{u.addEventListener("click",async()=>{const b=u.dataset.qid,p=document.getElementById(`answer-${b}`).value;if(!p.trim())return;if(u.disabled=!0,u.textContent="Gönderiliyor...",(await w(`/ilim/questions/${b}/answer/`,{method:"PATCH",body:{answer:p},requireAuth:!0}))._error)k("Cevap gönderilirken bir hata oluştu.","error"),u.disabled=!1,u.textContent="Cevapla ve Yayınla";else{k("Cevabınız başarıyla yayınlandı!","success"),u.textContent="Cevaplandı ✅",u.classList.add("btn--success");const x=document.getElementById(`q-card-${b}`);x.style.transition="all 0.5s ease",x.style.opacity="0",x.style.transform="translateY(-10px)",setTimeout(()=>{x.remove();const _=document.getElementById("tab-content-questions");_.querySelectorAll(".card").length===0&&(_.innerHTML='<div class="card card--dark" style="padding:24px; text-align:center; color:var(--text-muted); font-size:14px;">🎉 Tüm sorular cevaplanmış! Bekleyen soru yok.</div>')},500);const E=document.getElementById("stat-questions-label");if(E){const _=parseInt(E.textContent)||0;E.textContent=`${Math.max(0,_-1)} bekleyen`}}})})}async function d(){const c=document.getElementById("tab-content-announce");c.innerHTML=`
    ...
    `;async function g(){const f=await w("/community/announcements/"),u=document.getElementById("ann-list"),b=document.getElementById("stat-announce-label");b&&(b.textContent=f._error?"Hata":`${f.length} duyuru`),u.innerHTML=f.map(p=>`
      ...
      `).join(""),u.querySelectorAll(".delete-ann-btn").forEach(p=>{p.addEventListener("click",async()=>{if(!confirm("Bu duyuruyu kaldırmak istediğinize emin misiniz?"))return;const h=p.dataset.id;if(p.textContent="...",p.disabled=!0,(await w("/community/announcements/"+h+"/delete/",{method:"DELETE",requireAuth:!0}))._error)k("Duyuru silinemedi","error"),p.textContent="🗑️ Sil",p.disabled=!1;else{k("Duyuru başarıyla kaldırıldı","success");const E=document.getElementById("ann-card-"+h);E&&(E.style.transition="opacity 0.3s, transform 0.3s",E.style.opacity="0",E.style.transform="translateX(20px)",setTimeout(()=>{E.remove();const _=u.querySelectorAll(".card").length;document.getElementById("stat-announcements").textContent=_,_===0&&(u.innerHTML='<div class="card card--dark" style="padding:20px;text-align:center;color:var(--text-muted);font-size:14px;">Aktif duyuru yok.</div>')},300))}})})}document.getElementById("announcement-form").addEventListener("submit",async f=>{f.preventDefault();const u=document.getElementById("ann-submit-btn");u.disabled=!0,u.textContent="Yayınlanıyor...";const b={category:document.getElementById("ann-category").value,title:document.getElementById("ann-title").value,body:document.getElementById("ann-body").value,badge:document.getElementById("ann-badge").value||""};(await w("/community/announcements/create/",{method:"POST",body:b,requireAuth:!0}))._error?(k("Duyuru yayınlanırken bir hata oluştu.","error"),u.disabled=!1,u.textContent="📢 Duyuruyu Yayınla"):(k("Duyuru başarıyla yayınlandı!","success"),f.target.reset(),u.disabled=!1,u.textContent="📢 Duyuruyu Yayınla",await g())}),await g()}async function l(){const c=await w("/ziyaret/registrations/",{requireAuth:!0}),g=document.getElementById("tab-content-tours"),f=document.getElementById("stat-tours-label");if(f&&(f.textContent=c._error?"Hata":`${c.length} yeni kayıt`),c._error||c.length===0){g.innerHTML='<div class="card card--dark" style="padding:24px; text-align:center; color:var(--text-muted); font-size:14px;">Henüz tur kaydı bulunmuyor.</div>';return}g.innerHTML=`
    ...
    `}async function o(){const c=document.getElementById("tab-content-tourmanage"),g=`
      ...
      <div id="tm-list"></div>
    `;c.innerHTML=g;const f=async()=>{const u=await w("/ziyaret/admin/tours/",{requireAuth:!0}),b=document.getElementById("tm-list");if(u._error||u.length===0){b.innerHTML='<div style="text-align:center; color:var(--text-muted); font-size:14px;">Mevcut tur bulunamadı.</div>';return}b.innerHTML=u.map(p=>`
      ...
      <div id="cm-list"></div>
    `;const g=async()=>{const f=await w("/bagis/admin/campaigns/",{requireAuth:!0}),u=document.getElementById("cm-list"),b=document.getElementById("stat-campaigns-label");if(f._error){u.innerHTML='<div style="text-align:center; color:var(--text-danger); font-size:14px;">Kampanyalar yüklenirken hata oluştu.</div>',b&&(b.textContent="Hata");return}const p=f.filter(h=>h.is_active).length;if(b&&(b.textContent=`${p} aktif kampanya`),f.length===0){u.innerHTML='<div style="text-align:center; color:var(--text-muted); font-size:14px;">Henüz kampanya bulunmuyor.</div>';return}u.innerHTML=f.map(h=>`
        <div class="card card--dark" style="padding:14px; margin-bottom:10px; display:flex; justify-content:space-between; align-items:center;">
          <div style="flex:1;">
            <div style="display:flex; align-items:center; gap:8px;">
